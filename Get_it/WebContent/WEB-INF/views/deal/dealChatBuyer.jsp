...
<body>
	...
	webSocket.onmessage = function(message) {
		...
		$("#textArea").append('<div style="width:100%;height:8%;text-align:left;"><input type="button" class="btn btn-dark" value="'+message.data+'"></div>');
	...
	function sendMessage() {
		...
		// 콘솔에 메세지를 남긴다.
		$("#textArea").append('<div style="width:100%;height:8%;text-align:right;"><input type="button" class="btn btn-secondary" value="'+message.value+'"></div>');
		$("#textArea").scrollTop($("#textArea")[0].scrollHeight);
