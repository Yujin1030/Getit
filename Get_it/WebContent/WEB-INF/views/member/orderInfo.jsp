				...
				<div style="width: 100%">
					<table class="table" id="basket_1">
						<thead class="thead-dark">
							<tr>
								<th scope="col" style="width: 62%;">상품정보</th>
								<th scope="col" style="width: 5%;">주문일자</th>
								<th scope="col" style="width: 6%;">수량</th>
								<th scope="col" style="width: 12%;">주문금액</th>
							...
							<c:forEach items="${oList }" var="order" varStatus="status">
								...
								<div>
									...
									<ul>
										...
										<li>${order.pFileName}</li>

										<li>${order.pName}</li>
										<li>${order.pContents}</li>
										

										<li><a
											href="/member/change?orderNo=${order.orderNo}">교환신청</a></li>
										<li><a href="/member/return?orderNo=${order.orderNo }">반품신청</a></li>
										<li><a href="">배송조회</a></li>
										<li><a href="#">구매후기 쓰기</a></li>
