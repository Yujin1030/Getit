...
<body>
	...
	<section>
			...
			<div id="carouselExampleIndicators" class="carousel slide"
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img src="/Getit/WebContent/img/nakseo1.PNG" class="d-block w-100"
							alt="First" style="height: 800px;">
					</div>
					<div class="carousel-item">
						<img src="/Getit/WebContent/img/nakseo2.PNG" class="d-block w-100"
							alt="Second" style="height: 800px;">
					</div>
					<div class="carousel-item">
						<img src="/Getit/WebContent/img/nakseo3.PNG" class="d-block w-100"
							alt="Third" style="height: 800px;">
					</div>
				</div>
		...
		<div id="section_title2">
			...
			<p>Community</p>
			<p>
				<a href="/review/main">QnA</a> | <a href="#" style="font-weight: bold;">후기</a> | <a href="/qna/writeform">작성test</a>
			</p>
			<div id="wrap2">
